...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'POST /api/v1/user/forgot-password': 'UserController.forgot',
  'GET /api/v1/user/config-forgot-password': 'UserController.configForgotPassword',
  'POST /api/v1/user/password': 'UserController.password',
